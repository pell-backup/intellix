...
func (s *Submitter) handleVRFTaskResponse(ctx context.Context, response *types.RPCVoteFinalizedRequestIn) error {
...
func (s *Submitter) shouldReplaceVRFTaskResponse(ctx context.Context, existing, new *types.RPCVoteFinalizedRequestIn) bool {
	// TODO: add security threshold comparison
	return false
}

func (s *Submitter) wrapVRFTaskSubmitToChain(ctx context.Context, request *types.RPCVoteFinalizedRequestIn) error {
	...
	go func() {
		...
		err = s.submitVRFTaskResultToChain(ctx, request)
	}()
	wg.Wait()
	return err
}

func (s *Submitter) submitVRFTaskResultToChain(ctx context.Context, response *types.RPCVoteFinalizedRequestIn) error {
...
func (s *Submitter) queryVRFTaskTransaction(ctx context.Context, tx *ethtypes.Transaction, ethClient *ethclient.Client) error {
